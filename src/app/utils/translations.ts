...
export const translations = {
  en: {
    ...
    onboarding3Text: 'Receive thoughtful suggestions tailored to your wellness journey',
  ...
  pidgin: {
    ...
    onboarding3Text: 'Receive personal suggestions wey go fit your wellness journey',
